...
class VmPOSDashboard(tk.Tk):
    ...
    def _abrir_generador_codigo_barras(self):
        ...
        try:
            generador_class = GeneradorCodigoBarras
            
            if generador_class is None:
                try:
                    ...
                    generador_class = generador_module.GeneradorCodigoBarras
                    print("✅ Generador cargado dinámicamente")
            ...
            print("🚀 Creando instancia del generador...")
            generador = generador_class(parent=self)
            print("✅ Generador de códigos de barras iniciado correctamente")
            
            # Mostrar mensaje de confirmación
            messagebox.showinfo("✅ Códigos de Barras", 
                              "¡Generador de códigos de barras iniciado correctamente!\n\n"
                              "Puedes generar códigos en diferentes formatos:\n"
                              "• CODE128 (Recomendado)\n"
                              "• CODE39\n"
                              "• EAN13/EAN8\n"
                              "• UPC-A\n"
